...
public static class PointHelpers
{
    ...
    public static double GetDistanceBetweenPoints(Point point1, Point point2) =>
        MathHelpers.GetDistanceBetweenPoints(point1.X, point2.X, point1.Y, point2.Y);
    ...
    {
        return (endPoint.X - startPoint.X) * (midPoint.Y - startPoint.Y) -
               (endPoint.Y - startPoint.Y) * (midPoint.X - startPoint.X) <= 0.0 
                ? 1
                : -1;
    }
}
